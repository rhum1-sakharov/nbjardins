...
public class RemoveArtisanBanqueByEmailUETest {

    private RemoveArtisanBanqueByEmailUE usecase;
    ...
    public void setUp() throws Exception {
        ...
        this.usecase = new RemoveArtisanBanqueByEmailUE(ls, tm, artisanBanqueRepo);
    }
