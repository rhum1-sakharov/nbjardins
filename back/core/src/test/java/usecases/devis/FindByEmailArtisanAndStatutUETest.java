...
public class FindByEmailArtisanAndStatutUETest {

    FindByEmailArtisanAndStatutUE usecase;
    ...
    public void setUp() throws Exception {
        ...
        usecase = new FindByEmailArtisanAndStatutUE(ls, transactionManager, devisRepoPT);
    }
