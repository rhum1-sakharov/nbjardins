...
export const SCOPE = `${encodeURI('openid profile email')}`;
export const OAUTH_GOOGLE_CONNECTION_URL = `https://accounts.google.com/o/oauth2/v2/auth?scope=${SCOPE}&access_type=online&state=state_parameter_passthrough_value&redirect_uri=${OAUTH_GOOGLE_REDIRECT_URI}&response_type=code&client_id=${OAUTH_GOOGLE_ID}`
